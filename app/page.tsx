...
export default async function Page() {
  ...
  return (
    <main className="w-full min-h-screen flex justify-center bg-gradient-to-b from-[#0f172a] to-[#1e3a8a] text-white">

      <div className="w-full max-w-md p-4 space-y-3">

        <div className="w-full rounded-2xl bg-white/5 backdrop-blur p-4 space-y-3 shadow-xl">
